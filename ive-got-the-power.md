...
![50 years of CPU evolution: 1 core - 1971, 10 cores in 2019 \(MIPS: Million Instructions Per Second\)](.gitbook/assets/image%20%28201%29.png)
...
![A quadricore motherborad](.gitbook/assets/image%20%28124%29.png)

In our case, we have many instructions, we can use many cores!

![Comparison of the linear execution of a workflow that can be parallelized on programs 2 and 3.](.gitbook/assets/image%20%28194%29.png)
...
![A Snakemake rule](.gitbook/assets/image%20%28171%29.png)
...
![Snakemake execution order](.gitbook/assets/image%20%28108%29.png)
...
![Extract of our analysis workflow](.gitbook/assets/image%20%2844%29.png)
...
![Data flow provided by Snakemake](.gitbook/assets/image%20%28140%29.png)
...
![Interface for Filezilla connexion](.gitbook/assets/image%20%2886%29.png)
...
![Logo of the slurm scheduler](.gitbook/assets/image%20%28143%29.png)
